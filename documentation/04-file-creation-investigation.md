...
It also demonstrated the importance of contextual analysis when reviewing security telemetry.

A detected event does not automatically indicate malicious behavior.
